...
#define LUANICS_BEGIN_CHAPTER(name)\
	...
	namespace {\
		luanics::testing::core::Composite & chapterReference = LUANICS_CHAPTER_INSTANCE(name);
...
#define LUANICS_SECTION(name)\
	...
	luanics::testing::core::Installer LUANICS_SECTION_INSTALLER_INSTANCE_NAME(name){chapterReference, LUANICS_SECTION_INSTANCE_NAME(name)};\
...
#define LUANICS_BEGIN_SUBPROJECT(name)\
	...
	namespace {\
		luanics::testing::core::Composite & subprojectReference = LUANICS_SUBPROJECT_INSTANCE(name);
...
#define LUANICS_SUBPROJECT_TEST(name) \
	...
	luanics::testing::core::Installer LUANICS_SUBPROJECT_TEST_INSTALLER_INSTANCE(name){subprojectReference, LUANICS_SUBPROJECT_TEST_INSTANCE(name)}; \
